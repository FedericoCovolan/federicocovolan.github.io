/* @ds-bundle: {"format":3,"namespace":"PortfolioWebsiteDesignSystem_7a646e","components":[],"sourceHashes":{"pages.js":"32bd6cea2903"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.PortfolioWebsiteDesignSystem_7a646e = window.PortfolioWebsiteDesignSystem_7a646e || {});
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "pages.js", error: String((e && e.message) || e) }); }
